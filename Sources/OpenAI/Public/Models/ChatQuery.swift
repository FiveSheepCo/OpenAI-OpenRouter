    ...
    public enum ChatCompletionMessageParam: Codable, Equatable, Sendable {
        ...
        public struct UserMessageParam: Codable, Equatable, Sendable {
            ...
            public enum Content: Codable, Equatable, Sendable {
                ...
                public enum FileContent: Codable, Equatable, Sendable {
                    case chatCompletionContentPartTextParam(ChatCompletionContentPartTextParam)
                    case chatCompletionContentPartFileParam(ChatCompletionContentPartFileParam)
                    ...
                    public var file: Self.ChatCompletionContentPartFileParam.File? {
                        switch self {
                        case .chatCompletionContentPartFileParam(let file):
                                return file.file
                        default:
                            return nil
                        }
                    ...
                    public init(chatCompletionContentPartFileParam: ChatCompletionContentPartFileParam) {
                        self = .chatCompletionContentPartFileParam(chatCompletionContentPartFileParam)
                    }
                    ...
                    public func encode(to encoder: Encoder) throws {
                        ...
                        case .chatCompletionContentPartTextParam(let a0):
                            try container.encode(a0)
                        case .chatCompletionContentPartFileParam(let a0):
                            try container.encode(a0)
                        }
                    }
                    ...
                    enum CodingKeys: CodingKey {
                        case chatCompletionContentPartTextParam
                        case chatCompletionContentPartFileParam
                    }
                    ...
                    public struct ChatCompletionContentPartFileParam: Codable, Equatable, Sendable {
                        /// The type of the content part.
                        public let type: String
                        ...
                        public struct File: Codable, Equatable, Sendable {
                            ...
                            public init(name: String, data: Data, mimeType: String) {
                                self.fileName = name
                                self.fileData = "data:\(mimeType);base64,\(data.base64EncodedString())"
                            }
        ...
        public struct AssistantMessageParam: Codable, Equatable, Sendable {
            ...
            /// Cached annotaitons for OpenRouter, in order to avoid re-parsing of PDF documents.
    ...
    private indirect enum PropertyValue: Codable {
        ...
        init<T: Any>(from value: T) throws {
            ...
            case _ as Bool:
                ...
                return
            case _ as Int, _ as Int8, _ as Int16, _ as Int32, _ as Int64, _ as UInt, _ as UInt8, _ as UInt16,
                _ as UInt32, _ as UInt64:
        ...
        public struct FunctionDefinition: Codable, Equatable, Sendable {
            ...
            public struct FunctionParameters: Codable, Equatable, Sendable {
                ...
                public struct Property: Codable, Equatable, Sendable {
                    public typealias JSONType = ChatQuery.ChatCompletionToolParam.FunctionDefinition.FunctionParameters
                        .JSONType
